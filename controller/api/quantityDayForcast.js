...
module.exports.QuantityDayForcast = async function (req, res) {
  ...
  if (site.length > 0) {
    if (site[0].LoggerId != null && site[0].LoggerId != undefined) {
      ...
      startSubDate1.setMonth(startSubDate1.getMonth() - 1);

      let startSubDate2 = new Date(startDate);
      startSubDate2.setMonth(startSubDate2.getMonth() - 2);

      let startSubDate3 = new Date(startDate);
      startSubDate3.setMonth(startSubDate3.getMonth() - 3);
      ...
      for (let i = 0; i < spaceDay; i++) {
        ...
        startSubH2.setDate(startSubH2.getDate() - 2 + i);
        startSubH2.setHours(startSubH2.getHours() + startHour);

        let startSubH3 = new Date(startDate);
        startSubH3.setDate(startSubH3.getDate() - 3 + i);
        startSubH3.setHours(startSubH3.getHours() + startHour);

        let startSubH4 = new Date(startDate);
        startSubH4.setDate(startSubH4.getDate() - 4 + i);
        startSubH4.setHours(startSubH4.getHours() + startHour);

        //3m nearby previous
        let tSubDate1 = new Date(startSubDate1);
        tSubDate1.setDate(tSubDate1.getDate() - 1 + i);
        tSubDate1.setHours(tSubDate1.getHours() + startHour);
        let t2SubDate1 = new Date(startSubDate1);
        t2SubDate1.setDate(t2SubDate1.getDate() + i);
        t2SubDate1.setHours(t2SubDate1.getHours() + startHour);
        let t3SubDate1 = new Date(startSubDate1);
        t3SubDate1.setDate(t3SubDate1.getDate() + i + 1);
        t3SubDate1.setHours(t3SubDate1.getHours() + startHour);

        let tSubDate2 = new Date(startSubDate2);
        tSubDate2.setDate(tSubDate2.getDate() - 1 + i);
        tSubDate2.setHours(tSubDate2.getHours() + startHour);
        let t2SubDate2 = new Date(startSubDate2);
        t2SubDate2.setDate(t2SubDate2.getDate() + i);
        t2SubDate2.setHours(t2SubDate2.getHours() + startHour);
        let t3SubDate2 = new Date(startSubDate2);
        t3SubDate2.setDate(t3SubDate2.getDate() + i + 1);
        t3SubDate2.setHours(t3SubDate2.getHours() + startHour);

        let tSubDate3 = new Date(startSubDate3);
        tSubDate3.setDate(tSubDate3.getDate() - 1 + i);
        tSubDate3.setHours(tSubDate3.getHours() + startHour);
        let t2SubDate3 = new Date(startSubDate3);
        t2SubDate3.setDate(t2SubDate3.getDate() + i);
        t2SubDate3.setHours(t2SubDate3.getHours() + startHour);
        let t3SubDate3 = new Date(startSubDate3);
        t3SubDate3.setDate(t3SubDate3.getDate() + i + 1);
        t3SubDate3.setHours(t3SubDate3.getHours() + startHour);
        ...
        if (indexManual.length > 0) {
          ...
          if (
            ...
            // if (startSubH2.getDay() == 0) {
            //   quantityH2 = quantityH2 * 0.8;
            // }
            avgH += quantityH2;
            countAvgH += 1;
          }
          if (
            ...
            // if (startSubH3.getDay() == 0) {
            //   quantityH3 = quantityH3 * 0.8;
            // }
            avgH += quantityH3;
